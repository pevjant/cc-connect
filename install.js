...
// Downloads the pevjant fork binary for the current platform from GitHub
// Releases. Structure mirrors the upstream npm wrapper; only the repo and
// the removed Gitee fallback differ.
...
const GITHUB_REPO = "pevjant/cc-connect";
